...
class EventBillingPriceRate:
    ...
    and (optionally) with a particular quantum processor.
        ...
        Attributes:
            ...
            quantum_processor_id (str | Unset): If unset, this per-unit price applies to any quantum processor.
            unit_amount_decimal (float | Unset): The unit amount in currency to be charged.
            unit_label (str | Unset): Human-readable unit label infomation.
    """
