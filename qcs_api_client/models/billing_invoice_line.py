...
class BillingInvoiceLine:
    ...
    invoice period.
        ...
        Attributes:
            ...
            quantity (int):
            invoice_item (str | Unset):
            price (BillingPrice | Unset): A configuration for calculating the cost of `BillingProduct` usage
                based on quantity,
                and when that cost should be added as an invoice item.
            subscription (str | Unset):
            subscription_item (str | Unset):
    """
    ...
    metadata: BillingInvoiceLineMetadata
    quantity: int
    invoice_item: str | Unset = UNSET
    price: BillingPrice | Unset = UNSET
    subscription: str | Unset = UNSET
    subscription_item: str | Unset = UNSET
