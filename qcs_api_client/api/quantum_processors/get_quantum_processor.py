...
def _parse_response(*, response: httpx.Response) -> Error | QuantumProcessor | ValidationError:
...
def _build_response(*, response: httpx.Response) -> Response[Error | QuantumProcessor | ValidationError]:
...
) -> Response[Error | QuantumProcessor | ValidationError]:
