...
def _parse_response(*, response: httpx.Response) -> Error | ListAccountBillingInvoicesResponse | None:
...
def _build_response(*, response: httpx.Response) -> Response[Error | ListAccountBillingInvoicesResponse]:
...
) -> Response[Error | ListAccountBillingInvoicesResponse]:
